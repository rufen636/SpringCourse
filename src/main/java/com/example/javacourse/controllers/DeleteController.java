...
public class DeleteController {
    ...
    public ResponseEntity<String> deleteVacancy(@RequestBody DeleteVacancyRequest vacancyRequest) {
        System.out.println("Получен запрос: " + vacancyRequest);
